...
void buscar_por_mandante(BDTime *bd_t, BDPartidas *bd_p, int paginacao)
{
...
void buscar_por_visitante(BDTime *bd_t, BDPartidas *bd_p, int paginacao)
{
    printf("Digite o nome:\n");
    char prefixo[100];
    scanf("%99s", prefixo);
...
void buscar_por_m_ou_v(BDTime *bd_t, BDPartidas *bd_p, int paginacao)
{
    printf("Digite o nome:\n");
    char prefixo[100];
    scanf("%99s", prefixo);
